...
<HEAD>
    ...
    <SCRIPT type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#updateRoleButtonId").click(function () {
                var treeObj=$.fn.zTree.getZTreeObj("editUserRoleTree");
                ...
                <!--更新用户下的角色列表-->
                $.ajax({
                    url: "http://localhost:8001/user/updateRoleUnderUser",
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <div class="share share_size_large share_type_gplus">
                    <button class="share__btn" id="updateRoleButtonId">更新角色</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
